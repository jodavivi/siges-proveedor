...
exports.crearProveedor = async function (oParam) { 
    ...
    try {
        ...
        oRegistro.Codigo            = utilsGen.generarCodigo(seq.oData,5,"P");
        ...
        oRegistro.CodEstadoProveedor       = oParam.oData.iCodEstadoProveedor; 
        oRegistro.EstadoProveedor       = oParam.oData.sEstadoProveedor; 
...
exports.actualizarProveedor = async function (oParam) { 
    ...
    try {
        ...
        if(oParam.oData.iCodEstadoProveedor !== undefined){
            oRegistro.CodEstadoProveedor     = oParam.oData.iCodEstadoProveedor; 
        }
        if(oParam.oData.sEstadoProveedor !== undefined){
            oRegistro.EstadoProveedor     = oParam.oData.sEstadoProveedor; 
        }
